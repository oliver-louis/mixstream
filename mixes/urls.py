...
urlpatterns = [
    ...
    path("mixes/<int:pk>/playback-progress/", views.playback_progress, name="playback_progress"),
    path("playback-progress/latest/", views.latest_playback_progress, name="latest_playback_progress"),
